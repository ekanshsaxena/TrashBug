...
class DashboardOnePage extends StatelessWidget {
  ...
  Widget _buildAvatar(BuildContext context) {
    return IconButton(
      ...
      onPressed: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => TestImage()));
      },
    );
  }
