                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new Image(
                          ...
                          height: 191.0,
                          fit: BoxFit.fill,
                          image: new AssetImage('assets/img/garbadgeandpeople1.png')),
                    ),
                    Padding(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () async{
                      ...
                      try{
                        ...
                        await auth.login(loginEmailController.text, loginPasswordController.text);
                        showInSnackBar("Login successful");
                        Navigator.push(context, MaterialPageRoute(builder:(context)=> DashboardOnePage()));
                      }
                      catch(e){
                ...
                child: MaterialButton(
                    ...
                    onPressed: ()async{
                      if(signupPasswordController.text==signupConfirmPasswordController.text){
                        try {
                          AuthService auth=new AuthService();
                          await auth.signUp(signupEmailController.text, signupConfirmPasswordController.text, signupNameController.text);
